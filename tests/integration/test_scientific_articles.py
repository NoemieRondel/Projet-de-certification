...
class TestScientificArticles:
    ...
    def auth_headers(self):
        unique_email = f"test_sci_int_{uuid.uuid4().hex[:8]}@example.com"
        password = "TestPassword123!"
        unique_username = f"test_sci_int_{uuid.uuid4().hex[:4]}"
    ...
    def test_get_all_scientific_articles(self, auth_headers):
    ...
    def test_get_latest_scientific_articles(self, auth_headers):
        response = self.client.get(
